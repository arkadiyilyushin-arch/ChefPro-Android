...
object Routes {
    ...
    const val MORE_ANALYTICS = "more/analytics"
    const val MORE_MENU_ENGINEERING = "more/menu_engineering"
    const val MORE_PROFIT_LOSS = "more/profit_loss"
    const val MORE_FOOD_COST_TREND = "more/food_cost_trend"
    const val MORE_ABC_ANALYSIS = "more/abc_analysis"
    const val MORE_BREAKEVEN = "more/breakeven"
    const val MORE_SUPPLIER_ANALYTICS = "more/supplier_analytics"
    const val MORE_SALES = "more/sales"
    const val MORE_OPERATING_EXPENSES = "more/operating_expenses"
    const val MORE_PURCHASE_BUDGET = "more/purchase_budget"
    const val MORE_PLAN_VS_FACT = "more/plan_vs_fact"
    const val MORE_MARKUP_CALC = "more/markup_calc"
    const val MORE_PROFITABILITY = "more/profitability"
    const val MORE_PRICE_CALC = "more/price_calc"
    const val MORE_REPORTS = "more/reports"
    const val MORE_PDF_EXPORT = "more/pdf_export"
    const val MORE_CSV_EXPORT = "more/csv_export"
    const val MORE_WRITE_OFF_REPORT = "more/write_off_report"
    const val MORE_PURCHASE_FORECAST = "more/purchase_forecast"
    const val MORE_FC_BY_PERIOD = "more/fc_by_period"
    const val MORE_TOP_DISH_COST = "more/top_dish_cost"
    const val MORE_EXPIRY = "more/expiry"
    const val MORE_STOCK_MOVEMENTS = "more/stock_movements"
    const val MORE_AUDIT = "more/audit"
    const val MORE_AUTO_ORDER = "more/auto_order"
    const val MORE_TEMPERATURE = "more/temperature"
    const val MORE_BARCODE = "more/barcode"
    const val MORE_RECIPE_TEMPLATES = "more/recipe_templates"
    const val MORE_DISH_GALLERY = "more/dish_gallery"
    const val MORE_PRODUCTION_PLAN = "more/production_plan"
    const val MORE_DIGITAL_MENU = "more/digital_menu"
    const val MORE_MENU_COLLECTIONS = "more/menu_collections"
    const val MORE_UNIT_CONVERTER = "more/unit_converter"
    const val MORE_WORK_SCHEDULE = "more/work_schedule"
    const val MORE_EMPLOYEE_ACTIVITY = "more/employee_activity"
    const val MORE_CHECKLISTS = "more/checklists"
    const val MORE_FLOOR_PLAN = "more/floor_plan"
    const val MORE_RESERVATIONS = "more/reservations"
    const val MORE_LOYALTY = "more/loyalty"
    const val MORE_POS = "more/pos"
    const val MORE_RESTAURANTS = "more/restaurants"
    const val MORE_SUPPLIERS = "more/suppliers"
    const val MORE_EMPLOYEES = "more/employees"
    const val MORE_SYNC = "more/sync"
    const val MORE_BACKUP = "more/backup"
    const val MORE_SETTINGS = "more/settings"
    const val MORE_PROFILE = "more/profile"
    const val MORE_SHIFT = "more/shift"
    const val MORE_KITCHEN_BOARD = "more/kitchen_board"
    const val MORE_STOP_GO = "more/stop_go"
    const val MORE_WAITER = "more/waiter"
    const val MORE_WRITE_OFFS = "more/write_offs"
    const val MORE_PURCHASES = "more/purchases"
    const val MORE_KITCHEN_MODE = "more/kitchen_mode"
    const val MORE_SEARCH = "more/search"
